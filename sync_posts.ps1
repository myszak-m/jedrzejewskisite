...
$sourcePath = "C:\Obsidian Vault\posts"
$destinationPath = "C:\Users\mikje\OneDrive\Dokumenty\jedrzejewskisite\content\posts"

# Set Github repo 
$myrepo = "git@github.com:myszak-m/jedrzejewskisite.git"
